...
const IndexPage = ({data}) => (
  <Layout>
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-center py-10 md:py-20 md:px-44">
          ...
          <div className="w-2/5">
            <AnchorLink to="/#tarif" title="Tarif" className=" my-4 flex items-center">
              <button className="w-full text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 p-2 px-3 font-semibold">Nous contacter</button>
            </AnchorLink>          
          </div>
      </div>
      ...
      <div id="offre" className="md:px-44 py-20">
      ...
      <div id="tarif" className="md:px-44 py-20 bg-slate-100">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Combien ça coûte?</h5>
        <h6 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Seulement 350 Dhs. Non, non… Vous ne rêvez pas, ça coûte moins cher qu’un cours particulier de 2 heures.</h6> 
      </div>
      <div id="tarif" className="md:px-44 py-20">
          ...
          <div className="md:py-5 md:flex md:flex-row align-middle justify-center justify-content-center">
            <div class="md:w-1/4 my-4 md:my-0 p-6 md:max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">1 - Contactez nous par WhatsApp.</h5>
              </a>
              <p>Envoyez vos nom, prénom et adresse email</p>
              <a href="#" class="w-full inline-flex items-center py-2 px-2 my-4 text-sm font-bold text-center center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div class="md:w-1/4 md:ml-2  my-4 md:my-0 p-6 md:max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">2 - Dépôt Wafacash ou virement bancaire</h5>
            ...
            <div class="md:w-1/4 md:ml-2 md:mr-2 my-4 md:my-0 p-6 md:max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
